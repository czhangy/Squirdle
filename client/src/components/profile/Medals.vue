	...
	data() {
		return {
			medals: [
				...
				{
					title: "GYM LEADER CLAIRE",
					desc: "Capture 25 Dragon-type Pokémon",
					type: "gold",
				},
				{
					title: "GYM LEADER VALERIE",
